...
\newthought{Actually, with just} PASTA, Little's law and memorylessness we can already achieve quite a few interesting results for the $M/M/1$ queue.\sidenote{For the $M/G/1$ queue, things are bit subtler, see \cref{ex:l-216} and~\cref{sec:n-policies-mg1}.}
First observe that
\begin{equation*}
