...
The interarrival times of the tools at the microscope is $X\sim \Unif{3, 9}]$, and the inspection time~$S$ is such that $\E S = 5$ minutes and $\V S = 4$ minutes squared.
