...
The repair times $\{R_i\}$ are a set of iid rvs, distributed as the common rv~$E$ and have mean $\E R$ and finite second moment $\E{R^{2}}$.
...
With the above assumption that~$R$ is exponentially distributed, show~\cref{eq:f3}.
\begin{solution}
