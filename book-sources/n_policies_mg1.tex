...
\section{\texorpdfstring{$N$}{N}-policies for the \texorpdfstring{$M/G/1$}{MG1} queue}
...
To see this, observe that in~\cref{eq:33}, $T(q+1)$ is a function of $T(q)$ and $T(q-1)$.
Thus, $T(1)$ follows from $T(0)$, $T(2)$ from $T(1)$ and $T(0)$, and so on.
