...
% \node[block, below=1cm of PM, fill=gray!40] {$G/G/1$ Construction \& simulation};
 ...
 \caption{
An overview of the relations between the different types of times (interarrivals, arrivals, departures and so on) we use to construct a queueing process in continuous time.}
