...
Here is a first idea on how we can use the memoryless property of the interarrival times of the $M/G/1$ queue to find show that the expected busy time of the $M/G/1$ satisfies $\E \U = \E S/(1-\rho)$.
