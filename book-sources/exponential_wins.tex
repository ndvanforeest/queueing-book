...
\inputminted[firstline=33, lastline=35]{python}{../code/IBD_simulations.py} % inter-arrivals
...
In conclusion, if many patients arrive to the hospitial and each adds some small variation to the inter-arrival times, the hospital sees exponential inter-arrival tiems for the population.
