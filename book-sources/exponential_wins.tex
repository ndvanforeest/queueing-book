...
We next provide the formal background for the insights of the upper part of~\cref{fig:unitoexp}.
...
The ideas of the proofs for~\cref{thr:2} are used in potential theory and complex analysis, and the limiting function distribution is known as a harmonic function.
