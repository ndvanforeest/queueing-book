...
\inputminted[firstline=15, lastline=20]{python}{../code/ss_inventory_simulation.py} % data2
...
Thus, \mintinline{python}{(Pprime <= s)} implements the indicator function.
...
\inputminted[firstline=24, lastline=41]{python}{../code/ss_inventory_simulation.py} % simulation
